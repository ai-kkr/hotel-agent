...
T = TypeVar("T", bound="UpdateDomainCompanyInfoResponse200")


@_attrs_define
class UpdateDomainCompanyInfoResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_domain_company_info_response_200 = cls(
            data=data,
        )

        update_domain_company_info_response_200.additional_properties = d
        return update_domain_company_info_response_200
