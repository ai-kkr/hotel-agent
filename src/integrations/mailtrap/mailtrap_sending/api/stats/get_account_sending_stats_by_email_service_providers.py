...
from ...models.get_account_sending_stats_by_email_service_providers_email_service_providers_item import (
    GetAccountSendingStatsByEmailServiceProvidersEmailServiceProvidersItem,
)
from ...models.get_account_sending_stats_by_email_service_providers_response_200_item import (
    GetAccountSendingStatsByEmailServiceProvidersResponse200Item,
)
from ...models.get_account_sending_stats_by_email_service_providers_sending_streams_item import (
...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/stats/email_service_providers",
        "params": params,
    }
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    | list[GetAccountSendingStatsByEmailServiceProvidersResponse200Item]
    | None
):
    if response.status_code == 200:
        ...
        for response_200_item_data in _response_200:
            response_200_item = (
                GetAccountSendingStatsByEmailServiceProvidersResponse200Item.from_dict(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        sending_streams (list[GetAccountSendingStatsByEmailServiceProvidersSendingStreamsItem] |
            Unset):  Example: ['transactional', 'bulk'].
        categories (list[str] | Unset):  Example: ['Welcome Email', 'Password Reset'].
        email_service_providers
            (list[GetAccountSendingStatsByEmailServiceProvidersEmailServiceProvidersItem] | Unset):
    ...
    Returns:
        Response[BadRequestResponse | PermissionsDeniedResponse | RateLimitExceededResponse | UnauthenticatedResponse | list[GetAccountSendingStatsByEmailServiceProvidersResponse200Item]]
    """
...
def sync(
    *,
    ...
    Returns:
        BadRequestResponse | PermissionsDeniedResponse | RateLimitExceededResponse | UnauthenticatedResponse | list[GetAccountSendingStatsByEmailServiceProvidersResponse200Item]
    """
