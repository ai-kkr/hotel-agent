...
from ...models.get_account_sending_stats_email_service_providers_item import (
    GetAccountSendingStatsEmailServiceProvidersItem,
)
from ...models.get_account_sending_stats_sending_streams_item import (
...
def _get_kwargs(
    *,
    ...
    sending_streams: list[GetAccountSendingStatsSendingStreamsItem] | Unset = UNSET,
    categories: list[str] | Unset = UNSET,
    email_service_providers: list[GetAccountSendingStatsEmailServiceProvidersItem]
    | Unset = UNSET,
) -> dict[str, Any]:
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = SendingStats.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        sending_streams (list[GetAccountSendingStatsSendingStreamsItem] | Unset):  Example:
            ['transactional', 'bulk'].
        categories (list[str] | Unset):  Example: ['Welcome Email', 'Password Reset'].
        email_service_providers (list[GetAccountSendingStatsEmailServiceProvidersItem] | Unset):
    ...
    Returns:
        Response[BadRequestResponse | PermissionsDeniedResponse | RateLimitExceededResponse | SendingStats | UnauthenticatedResponse]
    """
...
def sync(
    *,
    ...
    Returns:
        BadRequestResponse | PermissionsDeniedResponse | RateLimitExceededResponse | SendingStats | UnauthenticatedResponse
    """
