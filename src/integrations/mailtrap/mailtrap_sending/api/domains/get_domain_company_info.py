...
from ...models.get_domain_company_info_response_200 import (
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = GetDomainCompanyInfoResponse200.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[GetDomainCompanyInfoResponse200 | NotFoundResponse | PermissionsDeniedResponse | UnauthenticatedResponse]
    """
...
def sync(
    ...
    *,
    ...
    Returns:
        GetDomainCompanyInfoResponse200 | NotFoundResponse | PermissionsDeniedResponse | UnauthenticatedResponse
    """
