...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    Domain | NotFoundResponse | PermissionsDeniedResponse | UnauthenticatedResponse
]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[Domain | NotFoundResponse | PermissionsDeniedResponse | UnauthenticatedResponse]
    """
