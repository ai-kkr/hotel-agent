...
) -> GetDomainsResponse200 | PermissionsDeniedResponse | UnauthenticatedResponse | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    GetDomainsResponse200 | PermissionsDeniedResponse | UnauthenticatedResponse
]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Returns:
        Response[GetDomainsResponse200 | PermissionsDeniedResponse | UnauthenticatedResponse]
    """
