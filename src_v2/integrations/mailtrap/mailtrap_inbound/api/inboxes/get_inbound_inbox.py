...
) -> ErrorResponse | ForbiddenError | Inbox | None:
    if response.status_code == 200:
        response_200 = Inbox.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorResponse | ForbiddenError | Inbox]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        ErrorResponse | ForbiddenError | Inbox
    """
