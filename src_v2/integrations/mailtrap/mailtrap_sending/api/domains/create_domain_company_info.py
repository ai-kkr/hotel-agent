...
from ...models.create_domain_company_info_body import CreateDomainCompanyInfoBody
from ...models.create_domain_company_info_response_200 import (
...
def _get_kwargs(
    domain_id: int,
    *,
    body: CreateDomainCompanyInfoBody,
) -> dict[str, Any]:
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = CreateDomainCompanyInfoResponse200.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[CreateDomainCompanyInfoResponse200 | NotFoundResponse | PermissionsDeniedResponse | UnauthenticatedResponse | UnprocessableEntity]
    """
...
def sync(
    ...
    *,
    ...
    Returns:
        CreateDomainCompanyInfoResponse200 | NotFoundResponse | PermissionsDeniedResponse | UnauthenticatedResponse | UnprocessableEntity
    """
