...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[GetWebhookResponse200 | NotFoundResponse | PermissionsDeniedResponse | UnauthenticatedResponse]
    """
...
def sync(
    ...
    *,
    ...
    Returns:
        GetWebhookResponse200 | NotFoundResponse | PermissionsDeniedResponse | UnauthenticatedResponse
    """
