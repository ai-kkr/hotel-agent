...
from ...models.get_account_sending_stats_by_categories_email_service_providers_item import (
    GetAccountSendingStatsByCategoriesEmailServiceProvidersItem,
)
from ...models.get_account_sending_stats_by_categories_response_200_item import (
    GetAccountSendingStatsByCategoriesResponse200Item,
)
from ...models.get_account_sending_stats_by_categories_sending_streams_item import (
...
def _get_kwargs(
    *,
    ...
    sending_streams: list[GetAccountSendingStatsByCategoriesSendingStreamsItem]
    | Unset = UNSET,
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    | list[GetAccountSendingStatsByCategoriesResponse200Item]
    | None
):
    if response.status_code == 200:
        ...
        for response_200_item_data in _response_200:
            response_200_item = (
                GetAccountSendingStatsByCategoriesResponse200Item.from_dict(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        sending_streams (list[GetAccountSendingStatsByCategoriesSendingStreamsItem] | Unset):
            Example: ['transactional', 'bulk'].
        categories (list[str] | Unset):  Example: ['Welcome Email', 'Password Reset'].
        email_service_providers (list[GetAccountSendingStatsByCategoriesEmailServiceProvidersItem]
    ...
    Returns:
        Response[BadRequestResponse | PermissionsDeniedResponse | RateLimitExceededResponse | UnauthenticatedResponse | list[GetAccountSendingStatsByCategoriesResponse200Item]]
    """
...
def sync(
    *,
    ...
    Returns:
        BadRequestResponse | PermissionsDeniedResponse | RateLimitExceededResponse | UnauthenticatedResponse | list[GetAccountSendingStatsByCategoriesResponse200Item]
    """
