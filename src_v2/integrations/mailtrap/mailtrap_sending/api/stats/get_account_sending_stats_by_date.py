...
from ...models.get_account_sending_stats_by_date_email_service_providers_item import (
    GetAccountSendingStatsByDateEmailServiceProvidersItem,
)
from ...models.get_account_sending_stats_by_date_response_200_item import (
    GetAccountSendingStatsByDateResponse200Item,
)
from ...models.get_account_sending_stats_by_date_sending_streams_item import (
...
def _get_kwargs(
    *,
    ...
    sending_streams: list[GetAccountSendingStatsByDateSendingStreamsItem]
    | Unset = UNSET,
    categories: list[str] | Unset = UNSET,
    email_service_providers: list[GetAccountSendingStatsByDateEmailServiceProvidersItem]
    | Unset = UNSET,
) -> dict[str, Any]:
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    | list[GetAccountSendingStatsByDateResponse200Item]
    | None
):
    if response.status_code == 200:
        ...
        for response_200_item_data in _response_200:
            response_200_item = GetAccountSendingStatsByDateResponse200Item.from_dict(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        sending_streams (list[GetAccountSendingStatsByDateSendingStreamsItem] | Unset):  Example:
            ['transactional', 'bulk'].
    ...
    Returns:
        Response[BadRequestResponse | PermissionsDeniedResponse | RateLimitExceededResponse | UnauthenticatedResponse | list[GetAccountSendingStatsByDateResponse200Item]]
    """
...
def sync(
    *,
    ...
    Returns:
        BadRequestResponse | PermissionsDeniedResponse | RateLimitExceededResponse | UnauthenticatedResponse | list[GetAccountSendingStatsByDateResponse200Item]
    """
