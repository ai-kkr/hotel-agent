...
T = TypeVar("T", bound="GetDomainCompanyInfoResponse200")


@_attrs_define
class GetDomainCompanyInfoResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_domain_company_info_response_200 = cls(
            data=data,
        )

        get_domain_company_info_response_200.additional_properties = d
        return get_domain_company_info_response_200
