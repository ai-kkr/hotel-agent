...
class WebhookCreateResponseData:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        elif isinstance(self.sending_stream, WebhookSendingStreamType1):
            sending_stream = self.sending_stream.value
        elif isinstance(self.sending_stream, WebhookSendingStreamType2Type1):
            sending_stream = self.sending_stream.value
        elif isinstance(self.sending_stream, WebhookSendingStreamType3Type1):
            sending_stream = self.sending_stream.value
        else:
