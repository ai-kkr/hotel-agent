    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if not isinstance(self.events, Unset):
            ...
            for events_item_data in self.events:
                ...
                elif isinstance(events_item_data, MessageEventOpen):
                    events_item = events_item_data.to_dict()
                elif isinstance(events_item_data, MessageEventClick):
                    events_item = events_item_data.to_dict()
                elif isinstance(events_item_data, MessageEventBounce):
                    events_item = events_item_data.to_dict()
                elif isinstance(events_item_data, MessageEventSpam):
                    events_item = events_item_data.to_dict()
                elif isinstance(events_item_data, MessageEventUnsubscribe):
                    events_item = events_item_data.to_dict()
                else:
                    events_item = events_item_data.to_dict()
